    ...
    try {
      ...
      const results = await Promise.all(
        DOC_TYPES.map(async (doc) => {
          ...
          const signingUrl = `${window.location.origin}/esign/${refNumber}?type=${doc.key}&name=${encodeURIComponent(customerName)}&email=${encodeURIComponent(customerEmail)}&leadId=${leadId}`;
